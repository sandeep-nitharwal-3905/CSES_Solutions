...
bool fun1(int r, int c, vector<string> &v)
{
    int a = r, b = c;
    while (a >= 0 && b >= 0)
    {
...
bool fun2(int r, int c, vector<string> &v)
{
    int a = r, b = c;
    while (a >= 0 && b < 8)
    {
...
bool fun3(int r, int c, vector<string> &v)
{
    int a = r, b = c;
    while (a >= 0)
    {
...
bool pos(int r, int c, vector<string> &v)
{
    if (v[r][c] == '*')
    {
        return 0;
    }
    if (fun1(r, c, v) && fun2(r, c, v) && fun3(r, c, v))
    {
        return 1;
    }
    return 0;
